  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Categories
        category: {
          medicine: "hsl(var(--category-medicine))",
          notes: "hsl(var(--category-notes))",
          sports: "hsl(var(--category-sports))",
          stationary: "hsl(var(--category-stationary))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 10px rgba(20, 150, 140, 0.4)" },
          "50%": { boxShadow: "0 0 20px rgba(20, 150, 140, 0.6)" },
        },
        "float": {
